                ...
                <div className="overflow-x-auto -mx-4 md:mx-0">
                  <div className="min-w-[600px] px-4 md:px-0">
                    <table className="w-full text-center border-separate border-spacing-0 bg-ctaColor rounded-lg shadow-lg">
                      <caption className="text-customLightGray text-2xl md:text-3xl font-normal mb-2 bg-black rounded-lg py-2 caption-top text-center">
          ...
          <div className="col-span-12">
            <div className="flex flex-col md:flex-row md:space-x-8 space-y-6 md:space-y-0">
              ...
              <div className="md:w-1/3 md:flex md:flex-col md:justify-start order-1 md:order-1">
                ...
                <p>See Zerodha's performance methodology</p>
