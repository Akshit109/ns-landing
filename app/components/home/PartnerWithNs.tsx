      ...
      <div className="h-[70vh] flex flex-col items-center justify-center text-center px-4">
        ...
        >
          ...
          <div className="mt-8 flex justify-center">
            <Link 
              href="/partner"
              className="inline-flex w-fit items-center gap-2 mt-2 px-4 py-2 bg-ctaColor text-customLightGray hover:bg-customLightGray hover:text-ctaColor transition-all duration-700 ease-in-out rounded-full shadow-sm font-medium no-underline"
            >
              Partner With Us
            </Link>
          </div>
