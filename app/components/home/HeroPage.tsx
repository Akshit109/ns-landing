    ...
    <div className='relative min-h-screen w-screen overflow-x-hidden'>
      ...
      <div className='relative w-screen flex flex-col items-center justify-center pt-24 md:pt-28 min-h-[calc(100vh-80px)]'>
        <div className='w-[90%] max-w-6xl mx-auto text-center px-4'>
          <motion.h1
            className='text-[2.75rem] sm:text-5xl md:text-[6.75rem] font-black mb-1 md:mb-2 drop-shadow-xl text-customLightGray leading-[1.1] pb-1 tracking-[0.10em]'
          ...
          <motion.h1
            className='text-[2.75rem] sm:text-5xl md:text-[6.75rem] font-black mb-1 md:mb-2 drop-shadow-xl text-customLightGray leading-[1.1] pb-1 tracking-[0.06em]'
            variants={textVariants}
            initial='hidden'
            animate='visible'
            custom={1}
          ...
          <motion.h1
            className='text-[2.95rem] sm:text-6xl md:text-[6.75rem] font-black mb-4 md:mb-6 drop-shadow-xl text-customLightGray leading-[1.1] pb-2 tracking-[0.05em] sm:tracking-[0.11em]'
            variants={textVariants}
            initial='hidden'
            animate='visible'
            custom={2}
